...
/**
 * Created by IntelliJ IDEA. User: ndw Date: Oct 18, 2008 Time: 2:19:04 PM To
...
public class XPointerTest extends TestCase {
	...
	/*
	 * public void testShortname() { XPointer xp = new XPointer("ncname");
	 * assertEquals(xp.xpathEquivalent(), "id(ncname)"); }
	 * 
	 * public void testElement() { XPointer xp = new
	 * XPointer("element(ncname)"); assertEquals(xp.xpathEquivalent(),
	 * "id(ncname)");
	 * 
	 * xp = new XPointer("element(/1/2)"); assertEquals(xp.xpathEquivalent(),
	 * "/*[1]/*[2]");
	 * 
	...
	public void testSchemes() {
		...
		try {
			...
			assertTrue(e.getMessage().contains("c:unk"));
		}
	}
}
